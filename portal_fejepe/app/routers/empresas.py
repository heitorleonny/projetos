...
def list_empresas(
    ...
    cluster: int | None = Query(default=None, ge=1, le=5, description="Filtrar por cluster cadastral (1-5)"),
    cluster_track: int | None = Query(default=None, ge=1, le=5, description="Filtrar por Cluster Track calculado (tracking_cluster_calculado). Agrupa EJs pelo cluster que estão performando no período."),
